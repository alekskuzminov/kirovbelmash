    ...
    <section id="projects" className="py-12 sm:py-20 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-8 sm:mt-12">
          <Link
            to="/projects"
            className="inline-block px-6 sm:px-8 py-3 bg-red-600 text-white text-sm sm:text-base font-semibold rounded-lg hover:bg-red-700 transition-colors shadow-md hover:shadow-lg whitespace-nowrap cursor-pointer"
          >
