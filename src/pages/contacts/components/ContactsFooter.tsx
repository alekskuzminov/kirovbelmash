        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <h4 className="text-base font-bold mb-6">
              <a href="/#equipment" className="hover:text-red-400 transition-colors cursor-pointer">
                Оборудование
              </a>
            </h4>
          ...
          <div>
            <h4 className="text-base font-bold mb-6">
              <a href="/#products" className="hover:text-red-400 transition-colors cursor-pointer">
            ...
            <h4 className="text-base font-bold mt-8 mb-4">
              <a href="/#about" className="hover:text-red-400 transition-colors cursor-pointer">
                О компании
              </a>
            </h4>
            <h4 className="text-base font-bold mb-4">
              <Link to="/contacts" className="hover:text-red-400 transition-colors cursor-pointer">
                Контакты
              </Link>
            </h4>
          </div>
