...
import { serviceAdvantages } from '../../../mocks/services';
import { Fragment } from 'react';

export default function ServicesAdvantages() {
  // Defensive check – the mock could be empty or undefined.
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {advantages.length > 0 ? (
            advantages.map((item, index) => (
              ...
              >
                <div className="w-12 h-12 flex items-center justify-center bg-red-50 rounded-xl mb-4 group-hover:bg-red-600 transition-colors duration-300">
                  {/* Guard against missing icon class names */}
                  <i
            ...
            <Fragment>
              {/* Fallback UI when there are no advantages to display */}
