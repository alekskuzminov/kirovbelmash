      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative rounded-2xl overflow-hidden">
          <div className="absolute inset-0 w-full h-full">
            <img
              src="https://readdy.ai/api/search-image?query=industrial%20factory%20interior%20panoramic%20view%20with%20warm%20lighting%20modern%20manufacturing%20equipment%20production%20line%20wide%20angle%20professional%20photography%20dark%20moody%20atmosphere&width=1200&height=500&seq=prjcta1&orientation=landscape"
