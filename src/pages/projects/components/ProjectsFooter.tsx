        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <h4 className="text-base font-bold mb-6">
              <a href="/gallery" className="hover:text-red-400 transition-colors cursor-pointer">
                Оборудование
              </a>
            </h4>
            <ul className="space-y-3">
              <li>
                <a href="/gallery" className="text-sm text-gray-400 hover:text-red-500 transition-colors cursor-pointer">
          ...
          <div>
            <h4 className="text-base font-bold mb-6">
              <Link to="/projects" className="hover:text-red-400 transition-colors cursor-pointer">
                Навигация
              </Link>
            </h4>
            <ul className="space-y-3">
