      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center space-x-8">
            ...
            <Link to="/about" className={`text-sm font-medium transition-colors whitespace-nowrap cursor-pointer ${isScrolled ? 'text-red-600' : 'text-red-400'}`}>
              О компании
            </Link>
      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden bg-white border-t border-gray-200">
          <div className="px-4 py-4 space-y-3">
            ...
            <Link to="/about" className="block py-2 text-sm font-medium text-red-600 cursor-pointer">О компании</Link>
