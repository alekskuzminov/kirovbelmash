...
export const SITE_CONFIG = {
  ...
  social: {
    // Replace with real Telegram link when available
    telegram: 'https://t.me/kirovbelmash',
    whatsapp: 'https://wa.me/79005218477',
  },

  assets: {
    // Temporary Readdy CDN logo — replace with local asset in Phase 1
    logo: 'https://static.readdy.ai/image/256c1827c8dbb947fa0f657e67320584/854bd2afa0b57ef90d2606cabd510734.png',
    logoAlt: 'КировБелМаш',
  },
} as const;
