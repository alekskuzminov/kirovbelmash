        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <div className="flex items-center space-x-3">
              <a
                ...
                className="w-10 h-10 flex items-center justify-center bg-gray-800 hover:bg-red-600 rounded-lg transition-colors cursor-pointer"
              >
          ...
          <div>
            <h4 className="text-base font-bold mb-6">
              <Link to="/services" className="hover:text-red-400 transition-colors cursor-pointer">
                Услуги
              </Link>
            </h4>
            <ul className="space-y-3">
              <li>
                <a href="#design" className="text-sm text-gray-400 hover:text-red-500 transition-colors cursor-pointer">
                  Проектирование
                </a>
              </li>
              <li>
                <a href="#installation" className="text-sm text-gray-400 hover:text-red-500 transition-colors cursor-pointer">
                  Монтаж оборудования
                </a>
              </li>
              <li>
                <a href="#commissioning" className="text-sm text-gray-400 hover:text-red-500 transition-colors cursor-pointer">
                  Пусконаладка
                </a>
              </li>
              <li>
                <a href="#training" className="text-sm text-gray-400 hover:text-red-500 transition-colors cursor-pointer">
                  Обучение персонала
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/" className="text-sm text-gray-400 hover:text-red-500 transition-colors cursor-pointer">
                  Главная
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-sm text-gray-400 hover:text-red-500 transition-colors cursor-pointer">
                  О компании
                </Link>
              </li>
              <li>
                <Link to="/gallery" className="text-sm text-gray-400 hover:text-red-500 transition-colors cursor-pointer">
              ...
              <li>
                <Link to="/contacts" className="text-sm text-gray-400 hover:text-red-500 transition-colors cursor-pointer">
                  Контакты
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start space-x-3">
                ...
                <div>
                  <div className="text-sm">sale@kirovbelmash.tw1.ru</div>
                </div>
              </li>
              <li className="flex items-start space-x-3">
