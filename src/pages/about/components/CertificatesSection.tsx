        ...
        <div className="mt-10 sm:mt-16 bg-white rounded-xl sm:rounded-2xl p-5 sm:p-8 lg:p-10 border border-gray-100 shadow-sm">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-10 items-center">
            ...
            <div className="relative w-full h-[200px] sm:h-[300px] rounded-xl overflow-hidden">
              <img
                src="https://readdy.ai/api/search-image?query=quality%20control%20inspection%20of%20industrial%20machinery%20equipment%20in%20modern%20factory%20setting%20engineer%20checking%20precision%20measurements%20with%20digital%20tools%20clean%20workshop%20environment%20professional%20industrial%20photography&width=600&height=300&seq=aboutqc1&orientation=landscape"
