      ...
      {isMobileMenuOpen && (
        <div className="lg:hidden bg-white border-t border-gray-200">
          <div className="px-4 py-4 space-y-3">
            <Link to="/" className="block py-2 text-sm font-medium text-gray-700 hover:text-red-600 cursor-pointer">
              Главная
            </Link>
            <Link to="/about" className="block py-2 text-sm font-medium text-gray-700 hover:text-red-600 cursor-pointer">
              О компании
            </Link>
            <Link to="/services" className="block py-2 text-sm font-medium text-gray-700 hover:text-red-600 cursor-pointer">
              Услуги
            </Link>
            <a href="/#products" className="block py-2 text-sm font-medium text-gray-700 hover:text-red-600 cursor-pointer">
              Продукция
            </a>
            <Link to="/gallery" className="block py-2 text-sm font-medium text-red-600 cursor-pointer">
              Галерея
            </Link>
            <Link to="/projects" className="block py-2 text-sm font-medium text-gray-700 hover:text-red-600 cursor-pointer">
              Проекты
            </Link>
            <Link to="/contacts" className="block py-2 text-sm font-medium text-gray-700 hover:text-red-600 cursor-pointer">
              Контакты
            </Link>
